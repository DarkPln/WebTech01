    ...
    <div class="footer-top">
        ...
        <div>
            ...
            <ul class="footer-links">
                <li><a href="<?php echo  BASE_URL ?>/cars?filter=neuwagen">Neuwagen</a></li>
                <li><a href="<?php echo  BASE_URL ?>/cars?filter=gebrauchtwagen">Gebrauchtwagen</a></li>
                <li><a href="<?php echo  BASE_URL ?>/cars?filter=elektro">Elektrofahrzeuge</a></li>
                <li><a href="<?php echo  BASE_URL ?>/cars?filter=sonderangebot">Sonderangebote</a></li>
            </ul>
        </div>
        <div>
            <div class="footer-heading">Kundenservice</div>
            <ul class="footer-links">
                <li><a href="<?php echo  BASE_URL ?>/listings/sell">Fahrzeug verkaufen</a></li>
                <li><a href="<?php echo  BASE_URL ?>/faq">Hilfe & FAQ</a></li>
                <li><a href="<?php echo  BASE_URL ?>/finanzierung">Finanzierung</a></li>
                <li><a href="<?php echo  BASE_URL ?>/versicherung">Versicherung</a></li>
            </ul>
        </div>
        <div>
            ...
            <ul class="footer-links">
                ...
                <li><a href="<?php echo  BASE_URL ?>/agb">AGB</a></li>
...
<script src="<?php echo  BASE_URL ?>/js/buchung.js"></script>
<script src="<?php echo  BASE_URL ?>/js/admin.js"></script>
<script src="<?php echo  BASE_URL ?>/js/inserat.js"></script>
