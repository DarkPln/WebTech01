    ...
    <main class="home-main">
        ...
        <section class="home-hero">
            <div class="home-hero-content">
                <div class="home-badge">Häufige Fragen</div>
                <h1>Hilfe & FAQ</h1>
                <p>Hier finden Sie Antworten auf die häufigsten Fragen rund um den Kauf, Verkauf und die Nutzung von Auto24.</p>
            </div>
        </section>
        ...
        <div class="faq-section">
            ...
            <div class="faq-category">
                ...
                <details class="faq-item">
                    ...
                    <p>Wenden Sie sich per E-Mail an datenschutz@auto24.de mit dem Betreff "Kontolöschung". Wir bearbeiten Ihre Anfrage innerhalb von 3 Werktagen. Alternativ können Sie alle Daten durch das Löschen des Browser-Speichers entfernen.</p>
                </details>
