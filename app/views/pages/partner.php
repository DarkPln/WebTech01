    ...
    <main class="home-main">
        ...
        <section class="home-hero">
            <div class="home-hero-content">
                <div class="home-badge">Starke Netzwerke</div>
                <h1>Unsere Partner</h1>
                <p>Auto24 arbeitet mit führenden Finanz-, Versicherungs- und Automobilpartnern zusammen, um Ihnen den bestmöglichen Service zu bieten.</p>
            </div>
        </section>
