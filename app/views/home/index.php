...
<body>
    ...
    <section class="home-hero">
        <div class="home-hero-content">
            ...
            <div class="home-buttons">
                <a href="<?php echo  BASE_URL ?>/cars" class="home-btn-primary">Autos ansehen</a>
                <a href="<?php echo  BASE_URL ?>/listings/sell" class="home-btn-secondary">Auto verkaufen</a>
            </div>
        </div>
    </section>
   ...
   <!-- Tim -->  
        ...
        <div class="car-carousel-viewport">
            <div class="car-carousel-track" id="carouselTrack" data-repeat="<?php echo  $carouselRepeat ?>">
                <?php for ($r = 0; $r < $carouselRepeat; $r++): ?>
                    ...
                    <a href="<?php echo  BASE_URL ?>/cars/detail?id=<?php echo  (int)$c['iid'] ?>" class="carousel-card">
    ...
    <section class="home-section">
        ...
        <div class="home-category-grid">
            <div class="home-category-card">
                ...
                <a href="<?php echo  BASE_URL ?>/cars">Autos kaufen</a>
            </div>
            <div class="home-category-card">
                <h3>Auto verkaufen</h3>
                <p>Inserieren Sie Ihr Fahrzeug schnell und unkompliziert.
                </p>
                <a href="<?php echo  BASE_URL ?>/listings/sell">Autos verkaufen</a>
            </div>
            <div class="home-category-card">
                <h3>Login-Bereich</h3>
                <p>Melden Sie sich an, um Inserate aufzugeben oder Autos zu buchen.</p>
                <a href="<?php echo  BASE_URL ?>/auth/login">Zum Login</a>
            </div>
        </div>
    </section>
    ...
    <section class="home-about">
        ...
        <a href="<?php echo  BASE_URL ?>/about" class="home-btn-secondary">Mehr erfahren</a>
    </section>
