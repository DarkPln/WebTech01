        ...
        <div class="user-dashboard">
            ...
            <div class="admin-tabs">
                ...
                <button class="admin-tab" data-target="tabNachrichten">
                    Nachrichten<span class="tab-badge" id="msgBadge"></span>
                </button>
            ...
            <div id="tabProfil" class="admin-tab-content active">
                ...
                <form id="profileForm">
                    <div class="user-profile-grid">
                        ...
                        <div>
                            <label for="email">E-Mail <span class="label-optional">(optional)</span></label>
                            <input type="email" id="email" name="email" autocomplete="email" placeholder="z.B. max@muster.de">
                        </div>
                        <div>
                            <label for="phone">Telefon <span class="label-optional">(optional)</span></label>
                            <input type="tel" id="phone" name="phone" autocomplete="tel" placeholder="z.B. +49 170 1234567">
                        </div>
                        <div>
                            <label for="city">Wohnort <span class="label-optional">(optional)</span></label>
                ...
                <form id="passwordForm">
                    <div class="user-profile-grid">
                        <div>
                            <label for="password">Neues Passwort <span class="required">*</span></label>
